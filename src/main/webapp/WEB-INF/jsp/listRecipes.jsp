...
<script >
  $(function() {
    $("table#titulo").tablesorter({ sortList: [[1,0]] });
  });
</script>        
...
<thead>
<tr>
<th><b><h4><span style="color:orange">Título</span></h4></b></th>
<th><b><h4><span style="color:orange">Data</span></h4></b></th>
...
<c:forEach var="recipe" items='${recipes}'>
		<h4><a href="/recipes/${recipe.externalId}">${recipe.title}</a>   

</c:forEach>
</td>
<td>
<c:forEach var="recipe" items='${recipes}'>
		<h4><a href="/recipes/${recipe.externalId}">${recipe.data}</a>   
