...
<html lang="en" class="translated-ltr"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body>
	...
	Solução: <textarea maxlenght="4" input type="text" name="solution"/></textarea><br/><br>
	Autor: <textarea maxlenght="4" input type="text" name="author"/></textarea><br/><br>
    </p>
    
		<div class="control-group">
      <label class="control-label"><h4>Classificação:</h4></label>
      <div class="controls">
        <input type="radio" name="classification" value="Fácil" required>
        Fácil<br/>
        <input type="radio" name="classification" value="Médio">
        Médio<br/>
        <input type="radio" name="classification" value="Dificil">
        Dificil<br/>
           <input type="radio" name="classification" value="Muito Dificil">
       Muito Dificil<br/>
       </div>
       </p>

	Tag: <textarea maxlenght="4" input type="text" name="tag"/></textarea></h4><br/><br>
